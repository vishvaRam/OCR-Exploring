...
from dots_ocr.utils.consts import MAX_PIXELS, MIN_PIXELS, image_extensions
from dots_ocr.utils.doc_utils import load_images_from_pdf
from dots_ocr.utils.format_transformer import layoutjson2md
from dots_ocr.utils.image_utils import (
    fetch_image,
    get_image_by_pymupdf_doc,
    smart_resize,
)
...
class DotsOCRParser:
    ...
    def _parse_single_image(
        ...
        if source == "image" and fitz_preprocess:
            image = get_image_by_pymupdf_doc(origin_image, target_dpi=self.dpi)
    ...
    def parse_pdf(self, input_path, filename, prompt_mode, save_dir):
        ...
        results = []
        with ThreadPool(num_thread) as pool:  # noqa: SIM117
